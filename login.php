          ...
          <div class="user_options-text">
            <div class="user_options-unregistered">
              <h2 class="user_unregistered-title">
                Nie masz konta?</h2>
              <p class="user_unregistered-text">Załóż konto w 5 minut</p>
              <button class="user_unregistered-signup" id="signup-button">Załóż</button>
            </div>
      
            <div class="user_options-registered">
              <h2 class="user_registered-title">Masz konto?</h2>
              <p class="user_registered-text">Zaloguj się na swoje konto Mazda i odkryj wszystkie możliwości usług Mazda</p>
              <button class="user_registered-login" id="login-button">Zaloguj się</button>
            </div>
          </div>
          
          <div class="user_options-forms" id="user_options-forms">
            <div class="user_forms-login">
              <h2 class="forms_title">Zaloguj się</h2>
              <form class="forms_form"action="auth.php" method="post">
                <fieldset class="forms_fieldset">
                  <div class="forms_field">
                    <input type="email" name="login" placeholder="Email" class="forms_field-input" required autofocus />
                  </div>
                  <div class="forms_field">
                    <input type="password" name="password" placeholder="Hasło" class="forms_field-input" required />
                  </div>
                </fieldset>
                <div class="forms_buttons">
                  <button type="button" class="forms_buttons-forgot">Zapomniałeś hasła?</button>
            ...
            <div class="user_forms-signup">
              ...
              <form class="forms_form" action="log.php" method="post">
                <fieldset class="forms_fieldset">
                  <div class="forms_field">
                    <input type="text" name="surname" placeholder="Nazwisko" class="forms_field-input" required />
                  </div>
                  <div class="forms_field">
                    <input type="email" name="login" placeholder="Email" class="forms_field-input" required />
                  </div>
                  <div class="forms_field">
                    <input type="password" name="password" placeholder="Hasło" class="forms_field-input" required />
                  </div>
                ...
                <div class="forms_buttons">
                  <input type="submit" value="Zarejestruj się" class="forms_buttons-action">
                </div>
              </form>
            </div>
          </div>
